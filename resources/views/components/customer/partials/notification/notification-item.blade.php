...
<div
    ...
    <div class="pl-3 flex flex-col justify-center gap-y-2 ml-auto">
        <x-customer.buttons.btn prepend-icon="check-lg" variant="light" link small class="hover:text-customer-dark-normal" />
        @if ($showDelete)
            <x-customer.buttons.btn prepend-icon="trash3-fill" variant="light" link small class="hover:text-customer-dark-normal" />
        @endif
    </div>
</div>
