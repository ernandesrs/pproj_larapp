            ...
            @if (count($breadcrumbs))
                <nav class="mb-2 flex items-center gap-x-3">
                    ...
                    @foreach ($breadcrumbs as $bread)
                        <a
                            wire:navigate
                            class="inline-block text-admin-primary-light-1 duration-300 hover:text-admin-primary-dark-2 {{ \Route::currentRouteName() == $bread['route']['name'] ? 'pointer-events-none opacity-50' : '' }}"
