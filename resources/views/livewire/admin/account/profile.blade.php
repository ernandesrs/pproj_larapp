            ...
            <x-slot name="content2">
                <x-admin.section title="Your security data" subtitle="Check and update your security data" no-shadow>
                    <x-slot name="content">
                        ...
                        <x-common.form.form wire:submit="updatePassword" submit-text="Update password"
                            submitting-text="Updating password">
                            <x-slot name="content">
                                <div class="flex flex-wrap gap-y-5">
                                    <div class="basis-full md:basis-6/12 md:pr-2">
                                        <x-common.form.input wire:model="password.password" type="password"
                                            label="Password" error="{{ $errors->first('password.password') }}" />
                                    </div>
